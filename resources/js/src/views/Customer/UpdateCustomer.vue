<template>
  <div v-if="showItem('Editar cliente')">
              ...
              <img
                ...
                :src="
                  typeof customer.photo === 'string'
                    ? `/uploads/thumbnail/${customer.photo}`
          ...
          <form data-vv-scope="step-5">
            <div class="vx-row">
              <img
                style="margin-left: auto; margin-right: auto"
                :src="
                  typeof customer.house === 'string'
                    ? `/uploads/thumbnail/${customer.house}`
                    : '/images/no-image-thumbnail.png'
                "
              />
            </div>
            ...
            <div class="vx-row">
              <UploadImages
                :max="1"
                maxError="Solo una foto"
                uploadMsg="Seleccione una foto de la casa del cliente"
                fileError="Error :("
...
export default {
  ...
  methods: {
    ...
    getClient() {
      ...
      vm.$vs.loading();
      axios
        .get(`/api/customer/${vm.$route.params.id}`)
        .then((response) => {
          vm.$vs.loading.close();
          ...
          this.FirstLastName = customer.firstLastName;
          this.SecondLastName = customer.secondLastName;
          if (customer.marriedName !== null)
            this.MarriedName = customer.marriedName;
          this.Dpi = customer.dpi;
          if (customer.nit !== null) this.Nit = customer.nit;
          this.BirthDate = customer.birthDate;
          this.Age = customer.age;
          this.Gender = customer.gender;
          this.PeopleDepend = customer.peopleDepend;
          this.CivilStatus = customer.civilStatus;
          this.Nationality = customer.nationality;
          this.Address = customer.address;
          if (customer.suburb !== null) this.Suburb = customer.suburb;
          if (customer.zone !== null) this.Zone = customer.zone;
          this.Departament = departament;
          this.Town = town;
          if (customer.telephone !== null) this.Telephone = customer.telephone;
          this.Home = customer.home;
          this.TimeHome = customer.timeHome;
          this.MonthlyPayment = customer.monthlyPayment;
          this.Mobile = customer.mobile;
          if (customer.email !== null) this.Email = customer.email;
          this.EconomicActivity = customer.economicActivity;
          this.ReferenceOne = {
          ...
          this.customer.photo = customer.img;
          this.customer.house = customer.imgHouse;
          (this.user = {
    ...
    save() {
      ...
      if (typeof this.customer.photo !== 'string')
        formData.append('file', this.customer.photo);
      if (typeof this.customer.house !== 'string')
        formData.append('house', this.customer.house);
      formData.append('_method', 'put');
      axios
        .post(`/api/customer/${this.id}`, formData, {
          headers: {
