...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    getName: function getName() {
      if (typeof localStorage.getItem('userInfo') === "undefined") return 'No Logueado';else return JSON.parse(localStorage.getItem('userInfo')).displayName;
    },
    getRol: function getRol() {
      if (typeof localStorage.getItem('userInfo') === "undefined") return 'No Logueado';else return JSON.parse(localStorage.getItem('userInfo')).userRole;
    },
  ...
  methods: {
    ...
    setVerticalNavMenuWidth: function setVerticalNavMenuWidth() {
      ...
      if (this.layoutType === 'vertical' || this.layoutType === 'horizontal' && this.windowWidth < 1200) if (this.windowWidth < 1200) {
        ...
        var _verticalNavMenuItemsMin = this.reduceButton && !this.isMouseEnter ? true : false;

        this.$store.commit('UPDATE_VERTICAL_NAV_MENU_ITEMS_MIN', _verticalNavMenuItemsMin); // Menu Action buttons

        this.clickNotClose = true;
        this.showCloseButton = false;

        var _verticalNavMenuWidth = this.isVerticalNavMenuReduced ? "reduced" : "default";

        this.$store.dispatch('updateVerticalNavMenuWidth', _verticalNavMenuWidth);
      }
    },
        ...
        [
          _c(
            ...
            [
              ...
              _vm._v(" "),
              _c("small", [_vm._v(_vm._s(_vm.getRol()))]),
            ]
          ),
          _vm._v(" "),
          _c(
...
if (typeof localStorage.getItem("permitKey") === "undefined") {
  ...
  if (permits.filter(function (x) {
    return x.idParent === "1" && x.status === 1;
  }).length > 0) myPermits.push({
    url: "/clientes",
    name: "Clientes",
    slug: "clientes",
    icon: "UserIcon"
  ...
  if (permits.filter(function (x) {
    return x.idParent === "8" && x.status === 1;
  }).length > 0) myPermits.push({
    url: "/solicitudes",
    name: "Solicitudes",
    slug: "solicitudes",
  ...
  if (permits.filter(function (x) {
    return x.idParent === "15" && x.status === 1;
  }).length > 0) myPermits.push({
    url: "/creditos",
    name: "Créditos",
    slug: "creditos",
  ...
  if (permits.filter(function (x) {
    return x.idParent === "25" && x.status === 1;
  }).length > 0) myPermits.push({
    url: "/cuentas",
    name: "Cuentas",
    slug: "ceuntas",
  ...
  if (permits.filter(function (x) {
    return x.idParent === "30" && x.status === 1;
  }).length > 0) myPermits.push({
    url: "/cajas",
    name: "Cajas",
    slug: "cajas",
  ...
  if (permits.filter(function (x) {
    return x.idParent === "36" && x.status === 1;
  }).length > 0) myPermits.push({
    url: "/transacciones",
    name: "Transacciones",
    slug: "transacciones",
  ...
  if (permits.filter(function (x) {
    return x.idParent === "40" && x.status === 1;
  }).length > 0) myPermits.push({
    url: "/cobrar",
    name: "Cobrar",
    slug: "cobrar",
  ...
  if (permits.filter(function (x) {
    return x.idParent === "43" && x.status === 1;
  }).length > 0) myPermits.push({
    url: "/usuarios",
    name: "Usuarios",
    slug: "usuarios",
  ...
  if (permits.filter(function (x) {
    ...
    return x.idParent === "48" && x.status === 1;
  }).length > 0) myPermits.push({
    url: "/permisos",
    name: "Permisos",
    slug: "permisos",
  ...
  if (permits.filter(function (x) {
    return x.idParent === "56" && x.status === 1;
  }).length > 0) myPermits.push({
    url: "/reportes",
    name: "Reportes",
    slug: "cobrar",
...
/* harmony default export */ __webpack_exports__["default"] = (myPermits);
